...
#include "translateFeatureFilter.h"
...
// Declare the plugin
vtkStandardNewMacro(translateFeatureFilter);
////////////////////////////////////////////////////////////////////////////////
// Constructor
// Fills the number of input and output objects.
// Initializes the members that need it.
translateFeatureFilter::translateFeatureFilter() {
...
int translateFeatureFilter::RequestData(
  vtkInformation *,
  ...
  vtkInformationVector *outputVector)
{
  ...
  **********************************************/
  ...
  // feat2BC[regionToMove] = Move::move;
  // feat2BC[regionToFix[0]] = Move::fix;
  // feat2BC[regionToFix[1]] = Move::fix;

  std::string srString = regionsToTranslate;
  ...
  for(int i = 0; i < featureVert.size(); ++i) {
    if(featureVert(i) > 0) {
      ...
      if(featureVert(i) == Move::move) {
        D_bc(itr, 0) = moveVector[0];
        D_bc(itr, 1) = moveVector[1];
        D_bc(itr, 2) = moveVector[2];
      }
      itr++;
    }
  }
  ...
  *****************************/
  ...
  igl::harmonic(V,F,b,D_bc,HarmonicOrder,D); // compute deformation field
  ...
  std::vector<vtkIdType> Vids(nVerts);
  vtkIdType inum = 0;
...
////////////////////////////////////////////////////////////////////////////////
void translateFeatureFilter::PrintSelf(std::ostream& os, vtkIndent indent) {
  this->Superclass::PrintSelf(os,indent);
  // os << "regionsToMove : "    << regionsToTranslate   << std::endl;
  // os << "regionsToFix  : " << regionsToFix << std::endl;
}

////////////////////////////////////////////////////////////////////////////////
int translateFeatureFilter::FillInputPortInformation(
...
////////////////////////////////////////////////////////////////////////////////
int translateFeatureFilter::FillOutputPortInformation(int, vtkInformation *info)
{
...
////////////////////////////////////////////////////////////////////////////////
int translateFeatureFilter::RequestInformation(
  vtkInformation *,
  vtkInformationVector ** inputVector,
  vtkInformationVector *outputVector)
{
