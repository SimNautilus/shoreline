/*=========================================================================
  ...
  Module:    vtkMySkeletonRepresentation
...
#ifndef vtkMySkeletonRepresentation_h
#define vtkMySkeletonRepresentation_h
...
class INTERACTIVESKELETONFILTERS_EXPORT vtkMySkeletonRepresentation
  : public vtkWidgetRepresentation
{
public:
  static vtkMySkeletonRepresentation* New();

  vtkTypeMacro(vtkMySkeletonRepresentation, vtkWidgetRepresentation);
  ...
  virtual void GetHandlePosition(int handle, double& x, double& y, double& z);
   ...
   */
  virtual double GetSummedLength(){return 42.0;};
...
protected:
  ...
  ~vtkMySkeletonRepresentation() override;

  // the skeleton data
  vtkSmartPointer<vtkMySkeletonSource> Skeleton;
  ...
  void ComputeJointArcLengths();
  void ApplySkeletonDisplacement();
  ...
  // bendable skeleton infrastructure b_
  Eigen::MatrixXd b_matL;
  Eigen::MatrixXd b_matM;
  Eigen::VectorXd b_arcLength;

  Eigen::MatrixXd b_vecb;
  Eigen::MatrixXd b_vecx;

  Eigen::FullPivLU<Eigen::MatrixXd> b_dec;

  std::vector<int>              b_vertexDegree;
  std::map<int, std::list<int>> b_neighborsMap;
  std::vector<int>              b_fixedVerts;
  std::vector<int>              b_bcVerts;
...
private:
  vtkMySkeletonRepresentation(const vtkMySkeletonRepresentation&) = delete;
  void operator=(const vtkMySkeletonRepresentation&) = delete;
};
