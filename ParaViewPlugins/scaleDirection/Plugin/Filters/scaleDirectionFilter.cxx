...
#include "scaleDirectionFilter.h"
...
// Declare the plugin
vtkStandardNewMacro(scaleDirectionFilter);
////////////////////////////////////////////////////////////////////////////////
// Constructor
// Fills the number of input and output objects.
// Initializes the members that need it.
scaleDirectionFilter::scaleDirectionFilter() {
...
int scaleDirectionFilter::RequestData(
  vtkInformation *,
  ...
  vtkInformationVector *outputVector)
{
  ...
  for(int i = 0; i < featureVert.size(); ++i) {
    if(featureVert(i) > 0) {
      ...
      if(featureVert(i) == Move::move) {
        D_bc(itr, 0) = V(i,0) * scaleVector[0];
        D_bc(itr, 1) = V(i,1) * scaleVector[1];
        D_bc(itr, 2) = V(i,2) * scaleVector[2];
      }
      itr++;
    }
  }
  ...
  *****************************/
  ...
  /**********************************
   * Compute new Directions and apply  *
   **********************************/
  ...
  vtkDebugMacro(<< "scaleDirection: " <<std::chrono::duration_cast<std::chrono::milliseconds>(endTime - startTime).count() << " ms");
  return 1;
}

////////////////////////////////////////////////////////////////////////////////
void scaleDirectionFilter::PrintSelf(std::ostream& os, vtkIndent indent) {
...
////////////////////////////////////////////////////////////////////////////////
int scaleDirectionFilter::FillInputPortInformation(
...
////////////////////////////////////////////////////////////////////////////////
int scaleDirectionFilter::FillOutputPortInformation(int, vtkInformation *info)
{
...
////////////////////////////////////////////////////////////////////////////////
int scaleDirectionFilter::RequestInformation(
  vtkInformation *,
  vtkInformationVector ** inputVector,
  vtkInformationVector *outputVector)
{
